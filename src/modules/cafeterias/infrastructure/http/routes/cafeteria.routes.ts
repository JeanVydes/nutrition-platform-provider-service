...
import { DeleteCafeteriaUseCase } from "@/core/application/use-cases/cafeterias/delete-cafeteria.use-case.js";
import { RegisterCafeteriaUseCase } from "@/core/application/use-cases/cafeterias/register-cafeteria.use-case.js";
import { UpdateCafeteriaUseCase } from "@/core/application/use-cases/cafeterias/update-cafeteria.use-case.js";
...
export async function cafeteriaRoutes(app: FastifyInstance): Promise<void> {
    ...
    const updateCafeteriaUseCase = new UpdateCafeteriaUseCase(cafeteriaRepository, providerRepository);
    const deleteCafeteriaUseCase = new DeleteCafeteriaUseCase(cafeteriaRepository);
    const cafeteriaController = new CafeteriaController(
        ...
        updateCafeteriaUseCase,
        deleteCafeteriaUseCase,
    );
    ...
    app.patch("/cafeterias/:id", cafeteriaController.updateCafeteria.bind(cafeteriaController));
    app.delete("/cafeterias/:id", cafeteriaController.deleteCafeteria.bind(cafeteriaController));
}
