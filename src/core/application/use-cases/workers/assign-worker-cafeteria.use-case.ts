import type { IWorkerAssignmentRepository } from '../../../domain/repositories/worker-assignment.repository';
...
import type { WorkerAssignment } from '../../../domain/entities/worker-assignment.entity';
