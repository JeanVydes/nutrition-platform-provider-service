...
export const schoolDbConfigs = pgTable("colegios_db_config", {
  ...
  schoolName: varchar("nombre_colegio", { length: 255 }),
...
export const providers = pgTable("proveedores", {
  ...
  billingAddress: varchar("direccion_facturacion", { length: 255 }),
...
export const cafeterias = pgTable("cafeterias", {
  ...
  providerId: uuid("id_proveedor").notNull().references(() => providers.id, { onDelete: 'cascade' }),
